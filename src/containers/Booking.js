...
function Booking() {
  ...
  return (
  <div>
    {currentQuestion !== questions.length -1 ? (<div className="px-16 py-12 font-normal">
    ...
    </div>) : (<div className="px-16 py-12 font-normal">
  <h1 className="text-[50px] uppercase mb-4">
{question}
</h1>
<p className="text-[28px] text-black/50">
      ...
      <div className="w-full flex flex-col p-2">
        ...
        <h3 className="font-poppins text-3xl font-normal">{question}</h3>
           ...
           if(type === 'radio') return (
                 ...
                 return(
                  <input type='text' className='w-2/4 h-screen bg-slate-50 shadow-sm'/>
                )
              })}
            </div>
          </div>
