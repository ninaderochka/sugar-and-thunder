            ...
            <form className="w-full">
              ...
              <div className="grid grid-cols-4 gap-2 text-input-grey space-y-4">
                ...
                <input
                  type="text"
                  placeholder="DD"
                  className="border border-input-border rounded-md text-sm p-3 aspect-square h-12 w-12 l-20"
                />
                <input
                  type="text"
                  placeholder="MM"
                ...
                <div className="flex justify-between gap-6 mx-auto text-center">
                  <button
                    type="button"
                    className="font-poppins font-normal text-button-blue text-2xl px-10 py-3 w-max outline border-button-blue leading-tight rounded shadow-md focus:bg-button-blue focus:shadow-lg focus:ring-0 focus:text-black focus:outline-none active:bg-button-blue/90 active:shadow-lg transition duration-150 ease-in-out"
                  >
                    Log in
                  </button>
                  <button
