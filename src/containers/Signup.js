...
function Signup() {
  return (
    ...
    <h1 className='uppercase text-5xl whitespace-nowrap flex justify-end mr-[360px] mt-10 py-6'>signup now</h1>
...
<div className='bg-white border-border-grey shadow-shadow-grey drop-shadow-lg box-border p-8 border-2 rounded min-w-min max-w-xl m-auto'>
    ...
    <div className="grid grid-cols-2 gap-5 text-input-grey">
              ...
              <input type="text" placeholder="Birth Date" className="p-0 align-middle" />
                <input type="text" placeholder="DD" className="border border-input-border rounded-md text-sm p-3 aspect-square h-12 w-12 l-20" />
                ...
                <div className='flex justify-between gap-6 mx-auto text-center'>
                <button type="button" className='font-poppins font-normal text-button-blue text-2xl px-10 py-3 w-max outline border-button-blue leading-tight rounded shadow-md focus:bg-button-blue focus:shadow-lg focus:ring-0 focus:text-black focus:outline-none active:bg-button-blue/90 active:shadow-lg transition duration-150 ease-in-out'>Log in</button>
                <button type="button" className='font-poppins font-normal text-button-blue text-2xl px-10 py-3 w-max outline border-button-blue leading-tight rounded shadow-md focus:bg-button-blue focus:shadow-lg focus:ring-0 focus:text-black focus:outline-none active:bg-button-blue/90 active:shadow-lg transition duration-150 ease-in-out'>Sign up</button>
              </div>
              </div>
    </form>
          </div>
    <div className="flex flex-row justify-center mb-8">
            <span className="absolute font-poppins bg-white px-4 font-light text-lg text-[#1D6B87]">Or</span>
