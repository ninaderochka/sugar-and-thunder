  ...
  return (
    <>
      ...
      >
        ...
        {!isOpen && (
          <div
            className={` transition-colors ease-in focus:text-light-yellow lg:flex lg:flex-row lg:items-center  focus:underline  ${
              isOpen
                ? 'background absoulute font-semi-bold m-3 flex  h-screen w-full scale-110 	flex-col items-center justify-center bg-light-blue  focus:underline text-3xl text-black'
                : 'hidden'
            }`}
          >
            <Link
              className={`m-2 p-3 focus:underline  focus:text-light-yellow focus:font-bold ${
                isOpen
            ...
            <Menu>
              <div className="relative m-2 p-1">
                <Link
                  className={` p-3 px-2  focus:underline  focus:text-light-yellow focus:font-bold ${
                    isOpen
                      ? 'duration-200	 hover:rounded-2xl hover:bg-light-yellow hover:p-6	'
                      : ''
                  } `}
            ...
            {user && (
              <Menu as="div" className="inline-block align-middle relative">
                <Menu.Button
                  ...
                  className="flex mx-3 text-sm bg-[#fec300] rounded-full  w-8 h-8  md:mr-0 focus:ring-4 focus:ring-gray-300"
                  type="button"
                >
                  ...
                  {user.photoURL ? (
                    ...
                    <span className="text-black m-auto text-center">
                      {user.displayName &&
                ...
                <div className="absolute -right-px">
                  ...
                  >
                    <Menu.Item>
                      <div className="px-4 py-3 text-sm text-gray-900 rounded-full">
            ...
            <select
              className="rounded-md text-center inline-flex items-center ml-5"
              value={lang}
