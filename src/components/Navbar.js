...
function Navbar() {
  return (
    <nav className='flex justify-between align-center p-4 h-[106px] bg-light-blue font-poppins' role='navigation'>
        <div className='pl-8 flex'>
         <img src={Logo} alt='logo' className='h-12 px-2'/>
        <Link to="/" className='text-5xl'>Healing</Link>
        </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        ...
        <div className='pr-8 text-xl focus:text-light-yellow underline-offset-2 transition-colors md:block hidden'>
            ...
            <button type="button" className='bg-button-blue rounded-md px-6 py-1 text-xl'>Log in</button>
        </div>
        <Routes>
