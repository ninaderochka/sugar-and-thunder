...
export default function ThankUSignup() {
  return (
    <div className="flex flex-col pt-12 pl-16">
      ...
      Your Sign Up request has been received, you will soon receive a confirmation email.<br/>Please follow the steps in the email to complete and activate your account.
      </p>
