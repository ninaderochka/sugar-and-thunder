    ...
    return(
        <div className='flex flex-col items-center lg:flex-row lg:items-start lg:mt-20 lg:mb-16  md:flex-row md:items-start sm:flex-row sm:items-start  md:mt-10 md:ml-4'>
            <div className='w-2/5'>
                ...
                <img className='w-8 h-8 md:h-12 md:w-12' src={SmallProfile}   />
                </div>
                <img className='h-44 w-40 md:h-64 md:w-60'  src={ProfileBig}  />
                </div>
            </div>
            <div className='w-4/5 sm:w-3/5 mr-0 sm:mr-8 xl:mr-0 '>
                <h1 className='text-2xl lg:text-5xl font-medium mb-8 pt-12 md:pt-0'>THERAPIST PROFILE</h1>
                ...
                <div className='flex mb-4'>
                    ...
                    <p className='xl:text-2xl md:text-xl items-center font-normal'>Bio</p>
                    </div>
