...
function Blog(){
    return(
        ...
        <div className='flex justify-center	content-center	pt-16 '>
            <img src={Rectangle45} alt=""  className=' top-[183px] rounded-3xl sm:w-[500px] lg:h-[500px] md:w-[700px] lg:w-[1116px] lg:h-[530px] '/>
        </div>
        <div className=' md:px-24  md:pt-10   sm:px-10 sm:pt-6    2xl:px-52  2xl:pt-20    lg:px-30 '>
        <h1 className='font-normal lg:text-5xl  md:text-2xl sm:text-xl  leading-[75px] uppercase '>Mental Health and Technology</h1>

        <p className='pt-6  uppercase   lg:text-xl    md:text-base    sm:text-sm leading-8'>Technology and mental well-being might seem like profoundly antagonistic terms. However, 
        there are excellent digital tools to help you reach mindfulness and to practice meditation. 
        You can even use smartphone apps, virtual reality solutions and digital devices as a form of relieving 
        stressing and achieving digital detox – as, after a while, you will be able to practice all types of anti-anxiety
         skills on your own. So, let The Medical Futurist 
        show you how you can enhance your mental and emotional health with the help of technology.</p>

        <h4 className='leading-[48px] font-[400] uppercase lg:text-3xl  md:text-2xl sm:text-xl  pt-16'>The need for taking care of our emotional health</h4>
...
The pressure to perform and the stress to achieve is the air every busy-bee is breathing. However, turbulent lifestyle comes with a price. No wonder so many people have mental health issues. In the US, that means one in five adults – more than 40 million Americans! On the old continent, 27 percent of the population has to cope with mental disorders, which means 83 million struggling Europeans. In Asia, the prevalence of depression is 20 percent in Thailand, 19.9 percent in Taiwan, 19.4 percent in Korea, 17.5 in Malaysia and 16.5 percent in China.
        ...
        <h4 className='font-normal lg:text-[32px] leading-[75px] uppercase     pt-6 md:text-2xl    sm:text-xl'>Sign up for The Healing blog</h4>

        <p className='leading-[30px] font-[400] uppercase lg:text-[20px] md:text-base    sm:text-sm'>A weekly, ad-free Blog that helps you stay in the know.</p>
        ...
        <h4 className='font-normal lg:text-[32px] leading-[75px] uppercase pt-20  md:text-2xl    sm:text-xl pb-8'>Recommended for you</h4>
        ...
        <div className='flex gap-4 pb-48 lg:flex-row  md:flex-col  sm:flex-col justify-center  items-center'>
              ...
              <div className="absolute text-white ml-8 mt-44 bg-text-background uppercase text-[32px] 
            bg-opacity-50  text-center align-middle leading-[48px]" >Heal from</div>
    
                <div className="absolute text-white ml-8 mt-[230px] bg-text-background uppercase  text-[32px]
             font-normal bg-opacity-50 inline-block align-middle leading-[48px]"> trauma{' '}</div>
                <img src={Rectangle41p} alt="" />
              </div>
    
    
              <div>
              <div className="absolute w-56 ml-4 mt-6  uppercase text-2xl 
            leading-7 " >Tell Me All I Need to Know About Anxiety</div>
